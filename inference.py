...
def main(args):
    ...
    with torch.set_grad_enabled(False):
        unet = ResUnetPlusPlus(in_channels=Dataset.in_channels, out_channels=Dataset.out_channels)
    ...
    for p in volumes:
        ...
        for s in range(x.shape[0]):
            ...
            filename = "{}-{}.jpeg".format(p, str(s).zfill(2))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--images", type=str, default="/home/mcn/ba/UTThucquan", help="root folder with images"
    )
    parser.add_argument(
        "--image-size",
        type=int,
